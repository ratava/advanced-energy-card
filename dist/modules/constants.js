    ...
    buildSchema(ctx) {
      ...
      return {
        ...
        battery: define([
          ...
          { name: 'sensor_bat1_state', label: fields.sensor_bat1_state.label, helper: fields.sensor_bat1_state.helper, selector: entitySelector },
          { name: 'sensor_bat2_state', label: fields.sensor_bat2_state.label, helper: fields.sensor_bat2_state.helper, selector: entitySelector },
          { name: 'sensor_bat3_state', label: fields.sensor_bat3_state.label, helper: fields.sensor_bat3_state.helper, selector: entitySelector },
          { name: 'sensor_bat4_state', label: fields.sensor_bat4_state.label, helper: fields.sensor_bat4_state.helper, selector: entitySelector },
        ...
        car: define([
          ...
          { name: 'sensor_car_state', label: fields.sensor_car_state.label, helper: fields.sensor_car_state.helper, selector: entitySelector },
          ...
          { name: 'sensor_car2_state', label: fields.sensor_car2_state.label, helper: fields.sensor_car2_state.helper, selector: entitySelector },
