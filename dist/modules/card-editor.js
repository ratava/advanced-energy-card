    ...
    return {
      en: {
        sections: {
          ...
          battery: { title: 'Battery', helper: 'Configure battery entities. A battery is not an individual battery cell/module but a collection of cells or a battery pack.' },
        ...
        fields: {
          ...
          sensor_bat1_soc: { label: 'Battery 1 SOC', helper: 'State of Charge sensor for Battery 1 (percentage).', helperByProfile: { overview: 'State of Charge sensor for Battery 1 (percentage). Battery SOC will be combined with all other batteries for card display' } },
          sensor_bat1_power: { label: 'Battery 1 Power', helper: 'Provide this combined power sensor or both charge/discharge sensors so Battery 1 becomes active.', helperByProfile: { overview: 'Provide this combined power sensor or both charge/discharge sensors. Battery power will be combined with all other batteries for card display.' } },
          ...
          sensor_battery1_temp: { label: 'Battery 1 Temperature Sensor', helper: 'Temperature sensor for Battery 1.' },
          battery1_temp_font_size: { label: 'Battery 1 Temp Font Size (px)', helper: 'Font size for Battery 1 temperature text.' },
          ...
          sensor_bat2_soc: { label: 'Battery 2 SOC', helper: 'State of Charge sensor for Battery 2 (percentage).', helperByProfile: { overview: 'State of Charge sensor for Battery 2 (percentage). Battery SOC will be combined with all other batteries for card display' } },
          sensor_bat2_power: { label: 'Battery 2 Power', helper: 'Provide this combined power sensor or both charge/discharge sensors so Battery 2 becomes active.', helperByProfile: { overview: 'Provide this combined power sensor or both charge/discharge sensors. Battery power will be combined with all other batteries for card display.' } },
          ...
          sensor_bat3_soc: { label: 'Battery 3 SOC', helper: 'State of Charge sensor for Battery 3 (percentage).', helperByProfile: { overview: 'State of Charge sensor for Battery 2 (percentage). Battery SOC will be combined with all other batteries for card display' } },
          sensor_bat3_power: { label: 'Battery 3 Power', helper: 'Provide this combined power sensor or both charge/discharge sensors so Battery 3 becomes active.', helperByProfile: { overview: 'Provide this combined power sensor or both charge/discharge sensors. Battery power will be combined with all other batteries for card display.' } },
          sensor_bat3_charge_power: { label: 'Battery 3 Charge Power', helper: 'Sensor for Battery 3 charging power.' },
          sensor_bat3_discharge_power: { label: 'Battery 3 Discharge Power', helper: 'Sensor for Battery 3 discharging power.' },
          ...
          sensor_bat4_soc: { label: 'Battery 4 SOC', helper: 'State of Charge sensor for Battery 4 (percentage).', helperByProfile: { overview: 'State of Charge sensor for Battery 2 (percentage). Battery SOC will be combined with all other batteries for card display' } },
          sensor_bat4_power: { label: 'Battery 4 Power', helper: 'Provide this combined power sensor or both charge/discharge sensors so Battery 4 becomes active.', helperByProfile: { overview: 'Provide this combined power sensor or both charge/discharge sensors. Battery power will be combined with all other batteries for card display.' } },
          ...
          hot_water_font_size: { label: 'Water Heating Font Size (px)', helper: '' },
          dishwasher_font_size: { label: 'Dish Washer Font Size (px)', helper: '' },
          ...
          grid_current_odometer_duration: { label: 'Odometer Duration (ms)', helper: 'Animation duration in milliseconds.' },
          ...
          sensor_grid_state: { label: 'Grid State Sensor', helper: 'Sensor entity for grid state text.' },
          ...
          grid_state_font_size: { label: 'Grid State Font Size (px)', helper: '' },
          sensor_solar_state: { label: 'Solar State Sensor', helper: 'Sensor entity for solar state text. Returns "Producing Power" or "Not Producing".' },
          ...
          solar_state_font_size: { label: 'Solar State Font Size (px)', helper: '' },
          sensor_solar_forecast_today: { label: 'Solar Forecast Today Sensor', helper: 'Sensor entity for today\'s solar energy forecast.' },
          sensor_solar_forecast_tomorrow: { label: 'Solar Forecast Tomorrow Sensor', helper: 'Sensor entity for tomorrow\'s solar energy forecast.' },
          sensor_weather_icon: { label: 'Weather Icon Sensor', helper: 'Sensor entity for weather icon text.' },
          weather_icon_color: { label: 'Weather Icon Color', helper: 'Color applied to the weather icon text.' },
          weather_icon_font_size: { label: 'Weather Icon Font Size (px)', helper: '' },
          sensor_weather_forecast: { label: 'Weather Forecast Sensor', helper: 'Sensor entity for weather forecast text.' },
          weather_forecast_color: { label: 'Weather Forecast Color', helper: 'Color applied to the weather forecast text.' },
          weather_forecast_font_size: { label: 'Weather Forecast Font Size (px)', helper: '' },
          ...
          stats_value_font_size: { label: 'Stats Value Font Size (px)', helper: 'Font size for all stat values.' },
          stats_label_color: { label: 'Stats Label Color', helper: 'Color applied to all stat labels.' },
          stats_label_font_size: { label: 'Stats Label Font Size (px)', helper: 'Font size for all stat labels.' },
          ...
          inverter1_status_font_size: { label: 'Inverter Status Font Size (px)', helper: 'Font size for inverter status text.' },
          sensor_inverter1_temp: { label: 'Inverter 1 Temperature Sensor', helper: 'Temperature sensor for Inverter 1.' },
          inverter1_temp_font_size: { label: 'Inverter 1 Temp Font Size (px)', helper: 'Font size for Inverter 1 temperature text.' },
          ...
          battery_charge_color: { label: 'Battery Charge Flow Color', helper: 'Colour used when energy is flowing into the battery.', helperByProfile: { overview: 'Flow Color for when power is flowing to the Battery Card' }},
          battery_discharge_color: { label: 'Battery Discharge Flow Color', helper: 'Colour used when energy is flowing from the battery.', helperByProfile: { overview: 'Flow Color for when power is flowing from the Battery Card' }},
          grid_import_color: { label: 'Inverter 1 Grid Import Flow Color', helper: 'Base colour before thresholds when inverter 1 is importing from the grid.', helperByProfile: { overview: 'Flow Color for when power in importing from the grid' }},
          grid_export_color: { label: 'Inverter 1 Grid Export Flow Color', helper: 'Base colour before thresholds when inverter 1 is exporting to the grid.', helperByProfile: { overview: 'Flow Color for when power in export to the grid' }},
          ...
          sensor_car_range: { label: 'Car 1 Range Sensor', helper: 'Sensor entity for EV 1 range.' },
          sensor_car_state: { label: 'Car 1 Charging State Sensor', helper: 'Sensor entity for EV 1 charging state text.' },
          sensor_car_hvac_status: { label: 'Car 1 HVAC Status Sensor', helper: 'Sensor entity for EV 1 HVAC/climate status.' },
          sensor_car_outside_temp: { label: 'Car 1 Outside Temperature Sensor', helper: 'Sensor entity for EV 1 outside temperature.' },
          sensor_car_inside_temp: { label: 'Car 1 Inside Temperature Sensor', helper: 'Sensor entity for EV 1 inside/cabin temperature.' },
          sensor_car_ac_temp: { label: 'Car 1 AC Temperature Sensor', helper: 'Sensor entity for EV 1 AC set temperature.' },
          ...
          sensor_car2_range: { label: 'Car 2 Range Sensor', helper: 'Sensor entity for EV 2 range.' },
          sensor_car2_state: { label: 'Car 2 Charging State Sensor', helper: 'Sensor entity for EV 2 charging state text.' },
          sensor_car2_hvac_status: { label: 'Car 2 HVAC Status Sensor', helper: 'Sensor entity for EV 2 HVAC/climate status.' },
          sensor_car2_outside_temp: { label: 'Car 2 Outside Temperature Sensor', helper: 'Sensor entity for EV 2 outside temperature.' },
          sensor_car2_inside_temp: { label: 'Car 2 Inside Temperature Sensor', helper: 'Sensor entity for EV 2 inside/cabin temperature.' },
          sensor_car2_ac_temp: { label: 'Car 2 AC Temperature Sensor', helper: 'Sensor entity for EV 2 AC set temperature.' },
          ...
          header_font_size: { label: 'Header Font Size (px)', helper: '' },
          daily_label_font_size: { label: 'Daily Label Font Size (px)', helper: '' },
          daily_value_font_size: { label: 'Daily Value Font Size (px)', helper: '' },
          pv_font_size: { label: 'PV Text Font Size (px)', helper: '' },
          windmill_power_font_size: { label: 'Windmill Power Font Size (px)', helper: '' },
          battery_soc_font_size: { label: 'Battery SOC Font Size (px)', helper: '' },
          battery_time_until_color: { label: 'Battery Time Until Color', helper: 'Hex color applied to the time until full/flat text.' },
          battery_time_until_font_size: { label: 'Battery Time Until Font Size (px)', helper: '' },
          ...
          battery_state_font_size: { label: 'Battery State Font Size (px)', helper: '' },
          battery_power_font_size: { label: 'Battery Power Font Size (px)', helper: '' },
          inv1_datetime_color: { label: 'Inverter 1 DateTime Color', helper: 'Color for Inverter 1 battery datetime display' },
          inv1_datetime_font_size: { label: 'Inverter 1 DateTime Font Size (px)', helper: 'Font size for Inverter 1 battery datetime.' },
          inv1_timeuntil_color: { label: 'Inverter 1 Time Until Color', helper: 'Color for Inverter 1 battery time until display' },
          inv1_timeuntil_font_size: { label: 'Inverter 1 Time Until Font Size (px)', helper: 'Font size for Inverter 1 battery time until.' },
          inv2_datetime_color: { label: 'Inverter 2 DateTime Color', helper: 'Color for Inverter 2 battery datetime display' },
          inv2_datetime_font_size: { label: 'Inverter 2 DateTime Font Size (px)', helper: 'Font size for Inverter 2 battery datetime.' },
          inv2_timeuntil_color: { label: 'Inverter 2 Time Until Color', helper: 'Color for Inverter 2 battery time until display' },
          inv2_timeuntil_font_size: { label: 'Inverter 2 Time Until Font Size (px)', helper: 'Font size for Inverter 2 battery time until.' },
          load_font_size: { label: 'Load Font Size (px)', helper: '' },
          ...
          heat_pump_font_size: { label: 'Heat Pump Font Size (px)', helper: '' },
          pool_font_size: { label: 'Pool Font Size (px)', helper: '' },
          washing_machine_font_size: { label: 'Washing Machine Font Size (px)', helper: '' },
          dryer_font_size: { label: 'Dryer Font Size (px)', helper: '' },
          refrigerator_font_size: { label: 'Refrigerator Font Size (px)', helper: '' },
          freezer_font_size: { label: 'Freezer Font Size (px)', helper: '' },
          ...
          car2_soc_font_size: { label: 'Car 2 SOC Font Size (px)', helper: '' },
          ...
          sensor_popup_pv_1_font_size: { label: 'PV Popup 1 Font Size (px)', helper: 'Font size for PV popup line 1.' },
          sensor_popup_pv_2_font_size: { label: 'PV Popup 2 Font Size (px)', helper: 'Font size for PV popup line 2.' },
          sensor_popup_pv_3_font_size: { label: 'PV Popup 3 Font Size (px)', helper: 'Font size for PV popup line 3.' },
          sensor_popup_pv_4_font_size: { label: 'PV Popup 4 Font Size (px)', helper: 'Font size for PV popup line 4.' },
          sensor_popup_pv_5_font_size: { label: 'PV Popup 5 Font Size (px)', helper: 'Font size for PV popup line 5.' },
          sensor_popup_pv_6_font_size: { label: 'PV Popup 6 Font Size (px)', helper: 'Font size for PV popup line 6.' },
          ...
          sensor_popup_house_1_font_size: { label: 'House Popup 1 Font Size (px)', helper: 'Font size for house popup line 1.' },
          ...
          sensor_popup_house_2_font_size: { label: 'House Popup 2 Font Size (px)', helper: 'Font size for house popup line 2.' },
          ...
          sensor_popup_house_3_font_size: { label: 'House Popup 3 Font Size (px)', helper: 'Font size for house popup line 3.' },
          ...
          sensor_popup_house_4_font_size: { label: 'House Popup 4 Font Size (px)', helper: 'Font size for house popup line 4.' },
          ...
          sensor_popup_house_5_font_size: { label: 'House Popup 5 Font Size (px)', helper: 'Font size for house popup line 5.' },
          ...
          sensor_popup_house_6_font_size: { label: 'House Popup 6 Font Size (px)', helper: 'Font size for house popup line 6.' },
          ...
          sensor_popup_car1_1_font_size: { label: 'Car 1 Popup 1 Font Size (px)', helper: 'Font size for car 1 popup line 1.' },
          ...
          sensor_popup_car1_2_font_size: { label: 'Car 1 Popup 2 Font Size (px)', helper: 'Font size for car 1 popup line 2.' },
          ...
          sensor_popup_car1_3_font_size: { label: 'Car 1 Popup 3 Font Size (px)', helper: 'Font size for car 1 popup line 3.' },
          ...
          sensor_popup_car1_4_font_size: { label: 'Car 1 Popup 4 Font Size (px)', helper: 'Font size for car 1 popup line 4.' },
          ...
          sensor_popup_car1_5_font_size: { label: 'Car 1 Popup 5 Font Size (px)', helper: 'Font size for car 1 popup line 5.' },
          ...
          sensor_popup_car1_6_font_size: { label: 'Car 1 Popup 6 Font Size (px)', helper: 'Font size for car 1 popup line 6.' },
          ...
          sensor_popup_car2_1_font_size: { label: 'Car 2 Popup 1 Font Size (px)', helper: 'Font size for car 2 popup line 1.' },
          ...
          sensor_popup_car2_2_font_size: { label: 'Car 2 Popup 2 Font Size (px)', helper: 'Font size for car 2 popup line 2.' },
          ...
          sensor_popup_car2_3_font_size: { label: 'Car 2 Popup 3 Font Size (px)', helper: 'Font size for car 2 popup line 3.' },
          ...
          sensor_popup_car2_4_font_size: { label: 'Car 2 Popup 4 Font Size (px)', helper: 'Font size for car 2 popup line 4.' },
          ...
          sensor_popup_car2_5_font_size: { label: 'Car 2 Popup 5 Font Size (px)', helper: 'Font size for car 2 popup line 5.' },
          ...
          sensor_popup_car2_6_font_size: { label: 'Car 2 Popup 6 Font Size (px)', helper: 'Font size for car 2 popup line 6.' },
          ...
          battery_popup_font_size: { label: 'Battery Popup Font Size (px)', helper: 'Global font size for all battery popup text.' },
          ...
          sensor_popup_grid_1_font_size: { label: 'Grid Popup 1 Font Size (px)', helper: 'Font size for grid popup line 1.' },
          ...
          sensor_popup_grid_2_font_size: { label: 'Grid Popup 2 Font Size (px)', helper: 'Font size for grid popup line 2.' },
          ...
          sensor_popup_grid_3_font_size: { label: 'Grid Popup 3 Font Size (px)', helper: 'Font size for grid popup line 3.' },
          ...
          sensor_popup_grid_4_font_size: { label: 'Grid Popup 4 Font Size (px)', helper: 'Font size for grid popup line 4.' },
          ...
          sensor_popup_grid_5_font_size: { label: 'Grid Popup 5 Font Size (px)', helper: 'Font size for grid popup line 5.' },
          ...
          sensor_popup_grid_6_font_size: { label: 'Grid Popup 6 Font Size (px)', helper: 'Font size for grid popup line 6.' },
          ...
          sensor_popup_inverter_1_font_size: { label: 'Inverter Popup 1 Font Size (px)', helper: 'Font size for inverter popup line 1.' },
          ...
          sensor_popup_inverter_2_font_size: { label: 'Inverter Popup 2 Font Size (px)', helper: 'Font size for inverter popup line 2.' },
          ...
          sensor_popup_inverter_3_font_size: { label: 'Inverter Popup 3 Font Size (px)', helper: 'Font size for inverter popup line 3.' },
          ...
          sensor_popup_inverter_4_font_size: { label: 'Inverter Popup 4 Font Size (px)', helper: 'Font size for inverter popup line 4.' },
          ...
          sensor_popup_inverter_5_font_size: { label: 'Inverter Popup 5 Font Size (px)', helper: 'Font size for inverter popup line 5.' },
      ...
      it: {
        sections: {
          ...
          battery: { title: 'Batteria', helper: 'Configura le entità della batteria. Una batteria non è una singola cella/modulo ma un insieme di celle o un pacco batteria.' },
        ...
        fields: {
          ...
          fluid_flow_stroke_width: { label: 'Spessore tratto Fluid Flow (px)', helper: 'Spessore base per animation_style: fluid_flow. Gli overlay/maschere sono derivati da questo.' },
          ...
          hot_water_font_size: { label: 'Dimensione font riscaldamento acqua (px)', helper: '' },
          dishwasher_font_size: { label: 'Dimensione font lavastoviglie (px)', helper: '' },
          ...
          grid_current_odometer_duration: { label: 'Durata odometro (ms)', helper: 'Durata dell\'animazione in millisecondi.' },
          ...
          sensor_grid_state: { label: 'Sensore Stato Rete', helper: 'Entità sensore per il testo dello stato della rete.' },
          ...
          grid_state_font_size: { label: 'Dimensione Font Stato Rete (px)', helper: '' },
          sensor_solar_state: { label: 'Sensore Stato Solare', helper: 'Entità sensore per il testo dello stato solare. Restituisce "Producing Power" o "Not Producing".' },
          ...
          solar_state_font_size: { label: 'Dimensione Font Stato Solare (px)', helper: '' },
          sensor_solar_forecast_today: { label: 'Sensore Previsione Solare Oggi', helper: 'Entità sensore per la previsione solare di oggi.' },
          sensor_solar_forecast_tomorrow: { label: 'Sensore Previsione Solare Domani', helper: 'Entità sensore per la previsione solare di domani.' },
          sensor_weather_icon: { label: 'Sensore Icona Meteo', helper: 'Entità sensore per l\'icona meteo.' },
          weather_icon_color: { label: 'Colore Icona Meteo', helper: 'Colore applicato al testo dell\'icona meteo.' },
          weather_icon_font_size: { label: 'Dimensione Font Icona Meteo (px)', helper: '' },
          sensor_weather_forecast: { label: 'Sensore Previsione Meteo', helper: 'Entità sensore per la previsione meteo.' },
          weather_forecast_color: { label: 'Colore Previsione Meteo', helper: 'Colore applicato al testo della previsione meteo.' },
          weather_forecast_font_size: { label: 'Dimensione Font Previsione Meteo (px)', helper: '' },
          ...
          stats_value_font_size: { label: 'Dimensione Font Valore Statistiche (px)', helper: 'Dimensione font per i valori.' },
          stats_label_color: { label: 'Colore Etichetta Statistiche', helper: 'Colore applicato alle etichette delle statistiche.' },
          stats_label_font_size: { label: 'Dimensione Font Etichetta Statistiche (px)', helper: 'Dimensione font per le etichette.' },
          ...
          inverter1_status_font_size: { label: 'Dimensione font Stato Inverter (px)', helper: 'Dimensione font per il testo dello stato inverter.' },
          ...
          sensor_car_range: { label: 'Sensore Autonomia Auto 1', helper: 'Entità sensore per l\'autonomia EV 1.' },
          sensor_car_state: { label: 'Sensore Stato Ricarica Auto 1', helper: 'Entità sensore per il testo dello stato di ricarica EV 1.' },
          sensor_car_hvac_status: { label: 'Sensore Stato HVAC Auto 1', helper: 'Entità sensore per lo stato HVAC/climatizzazione EV 1.' },
          sensor_car_outside_temp: { label: 'Sensore Temperatura Esterna Auto 1', helper: 'Entità sensore per la temperatura esterna EV 1.' },
          sensor_car_inside_temp: { label: 'Sensore Temperatura Interna Auto 1', helper: 'Entità sensore per la temperatura dell\'abitacolo EV 1.' },
          sensor_car_ac_temp: { label: 'Sensore Temperatura Climatizzatore Auto 1', helper: 'Entità sensore per la temperatura impostata del climatizzatore EV 1.' },
          ...
          sensor_car2_range: { label: 'Sensore Autonomia Auto 2', helper: 'Entità sensore per l\'autonomia EV 2.' },
          sensor_car2_state: { label: 'Sensore Stato Ricarica Auto 2', helper: 'Entità sensore per il testo dello stato di ricarica EV 2.' },
          sensor_car2_hvac_status: { label: 'Sensore Stato HVAC Auto 2', helper: 'Entità sensore per lo stato HVAC/climatizzazione EV 2.' },
          sensor_car2_outside_temp: { label: 'Sensore Temperatura Esterna Auto 2', helper: 'Entità sensore per la temperatura esterna EV 2.' },
          sensor_car2_inside_temp: { label: 'Sensore Temperatura Interna Auto 2', helper: 'Entità sensore per la temperatura dell\'abitacolo EV 2.' },
          sensor_car2_ac_temp: { label: 'Sensore Temperatura Climatizzatore Auto 2', helper: 'Entità sensore per la temperatura impostata del climatizzatore EV 2.' },
          ...
          header_font_size: { label: 'Dimensione font header (px)', helper: '' },
          daily_label_font_size: { label: 'Dimensione font etichetta giornaliera (px)', helper: '' },
          daily_value_font_size: { label: 'Dimensione font valore giornaliero (px)', helper: '' },
          pv_font_size: { label: 'Dimensione font PV (px)', helper: '' },
          windmill_power_font_size: { label: 'Dimensione font potenza mulino (px)', helper: '' },
          battery_soc_font_size: { label: 'Dimensione font SOC batteria (px)', helper: '' },
          ...
          battery_time_until_font_size: { label: 'Dimensione Font Tempo Rimanente (px)', helper: '' },
          ...
          battery_state_font_size: { label: 'Dimensione Font Stato Batteria (px)', helper: '' },
          battery_power_font_size: { label: 'Dimensione font potenza batteria (px)', helper: '' },
          inv1_datetime_color: { label: 'Colore DateTime Inverter 1', helper: 'Colore per la visualizzazione datetime batteria Inverter 1' },
          inv1_datetime_font_size: { label: 'Dimensione font DateTime Inverter 1 (px)', helper: 'Dimensione carattere per datetime batteria Inverter 1.' },
          ...
          inv1_timeuntil_font_size: { label: 'Dimensione font Tempo Fino a Inverter 1 (px)', helper: 'Dimensione carattere per tempo fino a batteria Inverter 1.' },
          inv2_datetime_color: { label: 'Colore DateTime Inverter 2', helper: 'Colore per la visualizzazione datetime batteria Inverter 2' },
          inv2_datetime_font_size: { label: 'Dimensione font DateTime Inverter 2 (px)', helper: 'Dimensione carattere per datetime batteria Inverter 2.' },
          ...
          inv2_timeuntil_font_size: { label: 'Dimensione font Tempo Fino a Inverter 2 (px)', helper: 'Dimensione carattere per tempo fino a batteria Inverter 2.' },
          load_font_size: { label: 'Dimensione font carico (px)', helper: '' },
          ...
          heat_pump_font_size: { label: 'Dimensione font pompa di calore (px)', helper: '' },
          pool_font_size: { label: 'Dimensione font piscina (px)', helper: '' },
          washing_machine_font_size: { label: 'Dimensione font lavatrice (px)', helper: '' },
          dryer_font_size: { label: 'Dimensione font asciugatrice (px)', helper: '' },
          refrigerator_font_size: { label: 'Dimensione font frigorifero (px)', helper: '' },
          freezer_font_size: { label: 'Dimensione font congelatore (px)', helper: '' },
          ...
          car2_soc_font_size: { label: 'Dimensione font SOC auto 2 (px)', helper: '' },
          ...
          sensor_popup_pv_1_font_size: { label: 'Lettergrootte Popup PV 1 (px)', helper: 'Lettergrootte voor PV-popup regel 1.' },
          sensor_popup_pv_2_font_size: { label: 'Lettergrootte Popup PV 2 (px)', helper: 'Lettergrootte voor PV-popup regel 2.' },
          sensor_popup_pv_3_font_size: { label: 'Lettergrootte Popup PV 3 (px)', helper: 'Lettergrootte voor PV-popup regel 3.' },
          sensor_popup_pv_4_font_size: { label: 'Lettergrootte Popup PV 4 (px)', helper: 'Lettergrootte voor PV-popup regel 4.' },
          sensor_popup_pv_5_font_size: { label: 'Lettergrootte Popup PV 5 (px)', helper: 'Lettergrootte voor PV-popup regel 5.' },
          sensor_popup_pv_6_font_size: { label: 'Lettergrootte Popup PV 6 (px)', helper: 'Lettergrootte voor PV-popup regel 6.' }
        },
        options: {
          languages: [
            { value: 'en', label: 'English' },
      ...
      de: {
        sections: {
          ...
          battery: { title: 'Batterie', helper: 'Batterie-Entitäten konfigurieren. Eine Batterie ist keine einzelne Zelle/Modul, sondern eine Sammlung von Zellen oder ein Batteriepaket.' },
        ...
        fields: {
          ...
          grid_current_odometer_duration: { label: 'Odometer Dauer ((ms))', helper: 'Animation duration in milliseconds.' },
          ...
          sensor_grid_state: { label: 'Netz Status Sensor', helper: 'Sensor-Entität für den Netz-Status-Text.' },
          ...
          grid_state_font_size: { label: 'Netz Status Font Size (px)', helper: '' },
          sensor_solar_state: { label: 'Solar Status Sensor', helper: 'Sensor-Entität für den Solar-Status-Text. Gibt "Producing Power" oder "Not Producing" zurück.' },
          ...
          solar_state_font_size: { label: 'Solar Status Font Size (px)', helper: '' },
          sensor_solar_forecast_today: { label: 'Solar Prognose Heute Sensor', helper: 'Sensor-Entität für die heutige Solarprognose.' },
          sensor_solar_forecast_tomorrow: { label: 'Solar Prognose Morgen Sensor', helper: 'Sensor-Entität für die morgige Solarprognose.' },
          sensor_weather_icon: { label: 'Wetter Icon Sensor', helper: 'Sensor-Entität für Wetter-Icon-Text.' },
          weather_icon_color: { label: 'Wetter Icon Farbe', helper: 'Farbe für den Wetter-Icon-Text.' },
          weather_icon_font_size: { label: 'Wetter Icon Schriftgröße (px)', helper: '' },
          sensor_weather_forecast: { label: 'Wettervorhersage Sensor', helper: 'Sensor-Entität für Wettervorhersage-Text.' },
          weather_forecast_color: { label: 'Wettervorhersage Farbe', helper: 'Farbe für den Wettervorhersage-Text.' },
          weather_forecast_font_size: { label: 'Wettervorhersage Schriftgröße (px)', helper: '' },
          ...
          inverter1_status_font_size: { label: 'Wechselrichter Status Schriftgröße (px)', helper: 'Schriftgröße für Wechselrichter-Statustext.' },
          ...
          sensor_car_range: { label: 'Auto 1 Reichweite Sensor', helper: 'Sensor-Entität für die Reichweite von EV 1.' },
          sensor_car_state: { label: 'Auto 1 Ladezustand-Text Sensor', helper: 'Sensor-Entität für den Ladezustand-Text von EV 1.' },
          sensor_car_hvac_status: { label: 'Auto 1 Klimaanlagen-Status Sensor', helper: 'Sensor-Entität für den Klimaanlagen-/HVAC-Status von EV 1.' },
          sensor_car_outside_temp: { label: 'Auto 1 Außentemperatur Sensor', helper: 'Sensor-Entität für die Außentemperatur von EV 1.' },
          sensor_car_inside_temp: { label: 'Auto 1 Innentemperatur Sensor', helper: 'Sensor-Entität für die Innenraumtemperatur von EV 1.' },
          sensor_car_ac_temp: { label: 'Auto 1 Klimaanlagen-Temperatur Sensor', helper: 'Sensor-Entität für die eingestellte Klimaanlagen-Temperatur von EV 1.' },
          ...
          sensor_car2_range: { label: 'Auto 2 Reichweite Sensor', helper: 'Sensor-Entität für die Reichweite von EV 2.' },
          sensor_car2_state: { label: 'Auto 2 Ladezustand-Text Sensor', helper: 'Sensor-Entität für den Ladezustand-Text von EV 2.' },
          sensor_car2_hvac_status: { label: 'Auto 2 Klimaanlagen-Status Sensor', helper: 'Sensor-Entität für den Klimaanlagen-/HVAC-Status von EV 2.' },
          sensor_car2_outside_temp: { label: 'Auto 2 Außentemperatur Sensor', helper: 'Sensor-Entität für die Außentemperatur von EV 2.' },
          sensor_car2_inside_temp: { label: 'Auto 2 Innentemperatur Sensor', helper: 'Sensor-Entität für die Innenraumtemperatur von EV 2.' },
          sensor_car2_ac_temp: { label: 'Auto 2 Klimaanlagen-Temperatur Sensor', helper: 'Sensor-Entität für die eingestellte Klimaanlagen-Temperatur von EV 2.' },
          ...
          header_font_size: { label: 'Header Font Size ((px))', helper: '' },
          daily_label_font_size: { label: 'Täglich Bezeichnung Font Size ((px))', helper: '' },
          daily_value_font_size: { label: 'Täglich Value Font Size ((px))', helper: '' },
          pv_font_size: { label: 'PV Text Font Size ((px))', helper: '' },
          windmill_power_font_size: { label: 'Windrad Leistung Font Size ((px))', helper: '' },
          battery_soc_font_size: { label: 'Batterie SOC Font Size ((px))', helper: '' },
          battery_time_until_color: { label: 'Batterie Zeit bis Voll/Leer Farbe', helper: 'Hex-Farbe für den Text der verbleibenden Zeit.' },
          battery_time_until_font_size: { label: 'Batterie Zeit bis Voll/Leer Font Size (px)', helper: '' },
          ...
          battery_state_font_size: { label: 'Batterie Status Font Size (px)', helper: '' },
          battery_power_font_size: { label: 'Batterie Leistung Font Size ((px))', helper: '' },
          inv1_datetime_color: { label: 'Wechselrichter 1 DateTime Farbe', helper: 'Farbe für Wechselrichter 1 Batterie DateTime-Anzeige' },
          inv1_datetime_font_size: { label: 'Wechselrichter 1 DateTime Font Size (px)', helper: 'Schriftgröße für Wechselrichter 1 Batterie DateTime.' },
          inv1_timeuntil_color: { label: 'Wechselrichter 1 Zeit Bis Farbe', helper: 'Farbe für Wechselrichter 1 Batterie Zeit Bis-Anzeige' },
          inv1_timeuntil_font_size: { label: 'Wechselrichter 1 Zeit Bis Font Size (px)', helper: 'Schriftgröße für Wechselrichter 1 Batterie Zeit Bis.' },
          inv2_datetime_color: { label: 'Wechselrichter 2 DateTime Farbe', helper: 'Farbe für Wechselrichter 2 Batterie DateTime-Anzeige' },
          inv2_datetime_font_size: { label: 'Wechselrichter 2 DateTime Font Size (px)', helper: 'Schriftgröße für Wechselrichter 2 Batterie DateTime.' },
          inv2_timeuntil_color: { label: 'Wechselrichter 2 Zeit Bis Farbe', helper: 'Farbe für Wechselrichter 2 Batterie Zeit Bis-Anzeige' },
          inv2_timeuntil_font_size: { label: 'Wechselrichter 2 Zeit Bis Font Size (px)', helper: 'Schriftgröße für Wechselrichter 2 Batterie Zeit Bis.' },
          load_font_size: { label: 'Load Font Size ((px))', helper: '' },
          ...
          car2_soc_font_size: { label: 'Auto 2 SOC Font Size ((px))', helper: '' },
          sensor_popup_pv_1: { label: 'PV Popup 1', helper: 'Entity for PV popup line 1.' },
          sensor_popup_pv_2: { label: 'PV Popup 2', helper: 'Entity for PV popup line 2.' },
          sensor_popup_pv_3: { label: 'PV Popup 3', helper: 'Entity for PV popup line 3.' },
          sensor_popup_pv_4: { label: 'PV Popup 4', helper: 'Entity for PV popup line 4.' },
          ...
          sensor_popup_house_1_font_size: { label: 'Haus Popup 1 Font Size ((px))', helper: 'Font size for house popup line 1.' },
          ...
          sensor_popup_house_2_font_size: { label: 'Haus Popup 2 Font Size ((px))', helper: 'Font size for house popup line 2.' },
          ...
          sensor_popup_house_3_font_size: { label: 'Haus Popup 3 Font Size ((px))', helper: 'Font size for house popup line 3.' },
          ...
          sensor_popup_house_4_font_size: { label: 'Haus Popup 4 Font Size ((px))', helper: 'Font size for house popup line 4.' },
          ...
          sensor_popup_house_5_font_size: { label: 'Haus Popup 5 Font Size ((px))', helper: 'Font size for house popup line 5.' },
          ...
          sensor_popup_house_6_font_size: { label: 'Haus Popup 6 Font Size ((px))', helper: 'Font size for house popup line 6.' },
          ...
          battery_popup_font_size: { label: 'Batterie Popup Schriftgröße (px)', helper: 'Globale Schriftgröße für allen Batterie-Popup-Text.' },
          ...
          sensor_popup_grid_1_font_size: { label: 'Netz Popup 1 Font Size ((px))', helper: 'Font size for grid popup line 1.' },
          ...
          sensor_popup_grid_2_font_size: { label: 'Netz Popup 2 Font Size ((px))', helper: 'Font size for grid popup line 2.' },
          ...
          sensor_popup_grid_3_font_size: { label: 'Netz Popup 3 Font Size ((px))', helper: 'Font size for grid popup line 3.' },
          ...
          sensor_popup_grid_4_font_size: { label: 'Netz Popup 4 Font Size ((px))', helper: 'Font size for grid popup line 4.' },
          ...
          sensor_popup_grid_5_font_size: { label: 'Netz Popup 5 Font Size ((px))', helper: 'Font size for grid popup line 5.' },
          ...
          sensor_popup_grid_6_font_size: { label: 'Netz Popup 6 Font Size ((px))', helper: 'Font size for grid popup line 6.' },
          ...
          sensor_popup_inverter_1_font_size: { label: 'Wechselrichter Popup 1 Font Size ((px))', helper: 'Font size for inverter popup line 1.' },
          ...
          sensor_popup_inverter_2_font_size: { label: 'Wechselrichter Popup 2 Font Size ((px))', helper: 'Font size for inverter popup line 2.' },
          ...
          sensor_popup_inverter_3_font_size: { label: 'Wechselrichter Popup 3 Font Size ((px))', helper: 'Font size for inverter popup line 3.' },
          ...
          sensor_popup_inverter_4_font_size: { label: 'Wechselrichter Popup 4 Font Size ((px))', helper: 'Font size for inverter popup line 4.' },
          ...
          sensor_popup_inverter_5_font_size: { label: 'Wechselrichter Popup 5 Font Size ((px))', helper: 'Font size for inverter popup line 5.' },
          ...
          sensor_popup_inverter_6_font_size: { label: 'Wechselrichter Popup 6 Font Size ((px))', helper: 'Font size for inverter popup line 6.' }
        },
        options: {
          languages: [
      ...
      fr: {
        sections: {
          ...
          battery: { title: 'Batterie', helper: 'Configurez les entités de batterie. Une batterie n\'est pas une cellule/module individuel mais un ensemble de cellules ou un pack batterie.' },
        ...
        fields: {
          ...
          grid_current_odometer_duration: { label: 'Odomètre Durée (ms)', helper: 'Animation duration in milliseconds.' },
          ...
          sensor_grid_state: { label: 'Capteur État Réseau', helper: 'Entité capteur pour le texte d\'état du réseau.' },
          ...
          grid_state_font_size: { label: 'Taille Police État Réseau (px)', helper: '' },
          sensor_solar_state: { label: 'Capteur État Solaire', helper: 'Entité capteur pour le texte d\'\u00e9tat solaire. Retourne "Producing Power" ou "Not Producing".' },
          ...
          solar_state_font_size: { label: 'Taille Police État Solaire (px)', helper: '' },
          sensor_solar_forecast_today: { label: 'Capteur Prévision Solaire Aujourd\'hui', helper: 'Entité capteur pour la prévision solaire d\'aujourd\'hui.' },
          sensor_solar_forecast_tomorrow: { label: 'Capteur Prévision Solaire Demain', helper: 'Entité capteur pour la prévision solaire de demain.' },
          sensor_weather_icon: { label: 'Capteur Icône Météo', helper: 'Entité capteur pour l\'icône météo.' },
          weather_icon_color: { label: 'Couleur Icône Météo', helper: 'Couleur appliquée au texte de l\'icône météo.' },
          weather_icon_font_size: { label: 'Taille Police Icône Météo (px)', helper: '' },
          sensor_weather_forecast: { label: 'Capteur Prévision Météo', helper: 'Entité capteur pour la prévision météo.' },
          weather_forecast_color: { label: 'Couleur Prévision Météo', helper: 'Couleur appliquée au texte de la prévision météo.' },
          weather_forecast_font_size: { label: 'Taille Police Prévision Météo (px)', helper: '' },
          ...
          sensor_car_range: { label: 'Voiture 1 Autonomie capteur', helper: 'Entité capteur pour l\'autonomie du VE 1.' },
          sensor_car_state: { label: 'Voiture 1 État de Charge capteur', helper: 'Entité capteur pour le texte d\'état de charge du VE 1.' },
          sensor_car_hvac_status: { label: 'Voiture 1 État Climatisation capteur', helper: 'Entité capteur pour l\'état HVAC/climatisation du VE 1.' },
          sensor_car_outside_temp: { label: 'Voiture 1 Température Extérieure capteur', helper: 'Entité capteur pour la température extérieure du VE 1.' },
          sensor_car_inside_temp: { label: 'Voiture 1 Température Intérieure capteur', helper: 'Entité capteur pour la température intérieure/habitacle du VE 1.' },
          sensor_car_ac_temp: { label: 'Voiture 1 Température Climatisation capteur', helper: 'Entité capteur pour la température de consigne de climatisation du VE 1.' },
          ...
          sensor_car2_range: { label: 'Voiture 2 Autonomie capteur', helper: 'Entité capteur pour l\'autonomie du VE 2.' },
          sensor_car2_state: { label: 'Voiture 2 État de Charge capteur', helper: 'Entité capteur pour le texte d\'état de charge du VE 2.' },
          sensor_car2_hvac_status: { label: 'Voiture 2 État Climatisation capteur', helper: 'Entité capteur pour l\'état HVAC/climatisation du VE 2.' },
          sensor_car2_outside_temp: { label: 'Voiture 2 Température Extérieure capteur', helper: 'Entité capteur pour la température extérieure du VE 2.' },
          sensor_car2_inside_temp: { label: 'Voiture 2 Température Intérieure capteur', helper: 'Entité capteur pour la température intérieure/habitacle du VE 2.' },
          sensor_car2_ac_temp: { label: 'Voiture 2 Température Climatisation capteur', helper: 'Entité capteur pour la température de consigne de climatisation du VE 2.' },
          ...
          header_font_size: { label: 'Header Font Size (px)', helper: '' },
          daily_label_font_size: { label: 'Journalier Libellé Font Size (px)', helper: '' },
          daily_value_font_size: { label: 'Journalier Value Font Size (px)', helper: '' },
          pv_font_size: { label: 'PV Text Font Size (px)', helper: '' },
          windmill_power_font_size: { label: 'Éolienne puissance Font Size (px)', helper: '' },
          battery_soc_font_size: { label: 'Batterie SOC Font Size (px)', helper: '' },
          ...
          battery_time_until_font_size: { label: 'Taille Police Temps Restant (px)', helper: '' },
          ...
          battery_state_font_size: { label: 'Taille Police État Batterie (px)', helper: '' },
          battery_power_font_size: { label: 'Batterie puissance Font Size (px)', helper: '' },
          inv1_datetime_color: { label: 'Couleur DateTime Onduleur 1', helper: 'Couleur pour l\'affichage datetime de la batterie Onduleur 1' },
          inv1_datetime_font_size: { label: 'Taille Font DateTime Onduleur 1 (px)', helper: 'Taille de police pour datetime batterie Onduleur 1.' },
          ...
          inv1_timeuntil_font_size: { label: 'Taille Font Temps Jusqu\'à Onduleur 1 (px)', helper: 'Taille de police pour temps jusqu\'à batterie Onduleur 1.' },
          inv2_datetime_color: { label: 'Couleur DateTime Onduleur 2', helper: 'Couleur pour l\'affichage datetime de la batterie Onduleur 2' },
          inv2_datetime_font_size: { label: 'Taille Font DateTime Onduleur 2 (px)', helper: 'Taille de police pour datetime batterie Onduleur 2.' },
          ...
          inv2_timeuntil_font_size: { label: 'Taille Font Temps Jusqu\'à Onduleur 2 (px)', helper: 'Taille de police pour temps jusqu\'à batterie Onduleur 2.' },
          load_font_size: { label: 'Load Font Size (px)', helper: '' },
          ...
          car2_soc_font_size: { label: 'Voiture 2 SOC Font Size (px)', helper: '' },
          sensor_popup_pv_1: { label: 'PV Popup 1', helper: 'Entity for PV popup line 1.' },
          sensor_popup_pv_2: { label: 'PV Popup 2', helper: 'Entity for PV popup line 2.' },
          sensor_popup_pv_3: { label: 'PV Popup 3', helper: 'Entity for PV popup line 3.' },
          sensor_popup_pv_4: { label: 'PV Popup 4', helper: 'Entity for PV popup line 4.' },
          ...
          sensor_popup_house_1_font_size: { label: 'Maison Popup 1 Font Size (px)', helper: 'Font size for house popup line 1.' },
          ...
          sensor_popup_house_2_font_size: { label: 'Maison Popup 2 Font Size (px)', helper: 'Font size for house popup line 2.' },
          ...
          sensor_popup_house_3_font_size: { label: 'Maison Popup 3 Font Size (px)', helper: 'Font size for house popup line 3.' },
          ...
          sensor_popup_house_4_font_size: { label: 'Maison Popup 4 Font Size (px)', helper: 'Font size for house popup line 4.' },
          ...
          sensor_popup_house_5_font_size: { label: 'Maison Popup 5 Font Size (px)', helper: 'Font size for house popup line 5.' },
          ...
          sensor_popup_house_6_font_size: { label: 'Maison Popup 6 Font Size (px)', helper: 'Font size for house popup line 6.' },
          ...
          sensor_popup_grid_1_font_size: { label: 'Réseau Popup 1 Font Size (px)', helper: 'Font size for grid popup line 1.' },
          ...
          sensor_popup_grid_2_font_size: { label: 'Réseau Popup 2 Font Size (px)', helper: 'Font size for grid popup line 2.' },
          ...
          sensor_popup_grid_3_font_size: { label: 'Réseau Popup 3 Font Size (px)', helper: 'Font size for grid popup line 3.' },
          ...
          sensor_popup_grid_4_font_size: { label: 'Réseau Popup 4 Font Size (px)', helper: 'Font size for grid popup line 4.' },
          ...
          sensor_popup_grid_5_font_size: { label: 'Réseau Popup 5 Font Size (px)', helper: 'Font size for grid popup line 5.' },
          ...
          sensor_popup_grid_6_font_size: { label: 'Réseau Popup 6 Font Size (px)', helper: 'Font size for grid popup line 6.' },
          ...
          sensor_popup_inverter_1_font_size: { label: 'Onduleur Popup 1 Font Size (px)', helper: 'Font size for inverter popup line 1.' },
          ...
          sensor_popup_inverter_2_font_size: { label: 'Onduleur Popup 2 Font Size (px)', helper: 'Font size for inverter popup line 2.' },
          ...
          sensor_popup_inverter_3_font_size: { label: 'Onduleur Popup 3 Font Size (px)', helper: 'Font size for inverter popup line 3.' },
          ...
          sensor_popup_inverter_4_font_size: { label: 'Onduleur Popup 4 Font Size (px)', helper: 'Font size for inverter popup line 4.' },
          ...
          sensor_popup_inverter_5_font_size: { label: 'Onduleur Popup 5 Font Size (px)', helper: 'Font size for inverter popup line 5.' },
          ...
          sensor_popup_inverter_6_font_size: { label: 'Onduleur Popup 6 Font Size (px)', helper: 'Font size for inverter popup line 6.' }
        },
        options: {
          languages: [
      ...
      nl: {
        sections: {
          ...
          battery: { title: 'Batterij', helper: 'Configureer batterij-entiteiten. Een batterij is geen individuele cel/module maar een verzameling cellen of een batterijpakket.' },
        ...
        fields: {
          ...
          grid_current_odometer_duration: { label: 'Odometer Duur (ms)', helper: 'Animation duration in milliseconds.' },
          ...
          sensor_grid_state: { label: 'Net Status Sensor', helper: 'Sensor entiteit voor net status tekst.' },
          ...
          grid_state_font_size: { label: 'Net Status Font Size (px)', helper: '' },
          sensor_solar_state: { label: 'Zonne-energie Status Sensor', helper: 'Sensor entiteit voor zonne-energie status tekst. Geeft "Producing Power" of "Not Producing" terug.' },
          ...
          solar_state_font_size: { label: 'Zonne-energie Status Font Size (px)', helper: '' },
          sensor_solar_forecast_today: { label: 'Zonne-energie Prognose Vandaag Sensor', helper: 'Sensor entiteit voor de zonne-energie prognose van vandaag.' },
          sensor_solar_forecast_tomorrow: { label: 'Zonne-energie Prognose Morgen Sensor', helper: 'Sensor entiteit voor de zonne-energie prognose van morgen.' },
          sensor_weather_icon: { label: 'Weer Icoon Sensor', helper: 'Sensor entiteit voor weer icoon tekst.' },
          weather_icon_color: { label: 'Weer Icoon Kleur', helper: 'Kleur toegepast op de weer icoon tekst.' },
          weather_icon_font_size: { label: 'Weer Icoon Lettergrootte (px)', helper: '' },
          sensor_weather_forecast: { label: 'Weersverwachting Sensor', helper: 'Sensor entiteit voor weersverwachting tekst.' },
          weather_forecast_color: { label: 'Weersverwachting Kleur', helper: 'Kleur toegepast op de weersverwachting tekst.' },
          weather_forecast_font_size: { label: 'Weersverwachting Lettergrootte (px)', helper: '' },
          ...
          inverter1_status_font_size: { label: 'Omvormer Status Lettergrootte (px)', helper: 'Lettergrootte voor omvormer statustekst.' },
          ...
          sensor_car_range: { label: 'Auto 1 Bereik sensor', helper: 'Sensor entiteit voor het bereik van EV 1.' },
          sensor_car_state: { label: 'Auto 1 Laadstatus-tekst sensor', helper: 'Sensor entiteit voor de laadstatus tekst van EV 1.' },
          sensor_car_hvac_status: { label: 'Auto 1 HVAC-status sensor', helper: 'Sensor entiteit voor de HVAC/klimaat status van EV 1.' },
          sensor_car_outside_temp: { label: 'Auto 1 Buitentemperatuur sensor', helper: 'Sensor entiteit voor de buitentemperatuur van EV 1.' },
          sensor_car_inside_temp: { label: 'Auto 1 Binnentemperatuur sensor', helper: 'Sensor entiteit voor de binnen-/cabinetemperatuur van EV 1.' },
          sensor_car_ac_temp: { label: 'Auto 1 Airco-temperatuur sensor', helper: 'Sensor entiteit voor de ingestelde airco-temperatuur van EV 1.' },
          ...
          sensor_car2_range: { label: 'Auto 2 Bereik sensor', helper: 'Sensor entiteit voor het bereik van EV 2.' },
          sensor_car2_state: { label: 'Auto 2 Laadstatus-tekst sensor', helper: 'Sensor entiteit voor de laadstatus tekst van EV 2.' },
          sensor_car2_hvac_status: { label: 'Auto 2 HVAC-status sensor', helper: 'Sensor entiteit voor de HVAC/klimaat status van EV 2.' },
          sensor_car2_outside_temp: { label: 'Auto 2 Buitentemperatuur sensor', helper: 'Sensor entiteit voor de buitentemperatuur van EV 2.' },
          sensor_car2_inside_temp: { label: 'Auto 2 Binnentemperatuur sensor', helper: 'Sensor entiteit voor de binnen-/cabinetemperatuur van EV 2.' },
          sensor_car2_ac_temp: { label: 'Auto 2 Airco-temperatuur sensor', helper: 'Sensor entiteit voor de ingestelde airco-temperatuur van EV 2.' },
          ...
          header_font_size: { label: 'Header Font Size (px)', helper: '' },
          daily_label_font_size: { label: 'Dagelijks Label Font Size (px)', helper: '' },
          daily_value_font_size: { label: 'Dagelijks Value Font Size (px)', helper: '' },
          pv_font_size: { label: 'PV Text Font Size (px)', helper: '' },
          windmill_power_font_size: { label: 'Windmolen vermogen Font Size (px)', helper: '' },
          battery_soc_font_size: { label: 'Batterij SOC Font Size (px)', helper: '' },
          ...
          battery_time_until_font_size: { label: 'Batterij Tijd Tot Vol/Leeg Font Size (px)', helper: '' },
          ...
          battery_state_font_size: { label: 'Batterij Status Font Size (px)', helper: '' },
          battery_power_font_size: { label: 'Batterij vermogen Font Size (px)', helper: '' },
          inv1_datetime_color: { label: 'Omvormer 1 DateTime Kleur', helper: 'Kleur voor Omvormer 1 batterij datetime weergave' },
          inv1_datetime_font_size: { label: 'Omvormer 1 DateTime Font Size (px)', helper: 'Lettergrootte voor Omvormer 1 batterij datetime.' },
          inv1_timeuntil_color: { label: 'Omvormer 1 Tijd Tot Kleur', helper: 'Kleur voor Omvormer 1 batterij tijd tot weergave' },
          inv1_timeuntil_font_size: { label: 'Omvormer 1 Tijd Tot Font Size (px)', helper: 'Lettergrootte voor Omvormer 1 batterij tijd tot.' },
          inv2_datetime_color: { label: 'Omvormer 2 DateTime Kleur', helper: 'Kleur voor Omvormer 2 batterij datetime weergave' },
          inv2_datetime_font_size: { label: 'Omvormer 2 DateTime Font Size (px)', helper: 'Lettergrootte voor Omvormer 2 batterij datetime.' },
          inv2_timeuntil_color: { label: 'Omvormer 2 Tijd Tot Kleur', helper: 'Kleur voor Omvormer 2 batterij tijd tot weergave' },
          inv2_timeuntil_font_size: { label: 'Omvormer 2 Tijd Tot Font Size (px)', helper: 'Lettergrootte voor Omvormer 2 batterij tijd tot.' },
          load_font_size: { label: 'Load Font Size (px)', helper: '' },
          ...
          sensor_popup_house_1_font_size: { label: 'Huis Popup 1 Font Size (px)', helper: 'Font size for house popup line 1.' },
          ...
          sensor_popup_house_2_font_size: { label: 'Huis Popup 2 Font Size (px)', helper: 'Font size for house popup line 2.' },
          ...
          sensor_popup_house_3_font_size: { label: 'Huis Popup 3 Font Size (px)', helper: 'Font size for house popup line 3.' },
          ...
          sensor_popup_house_4_font_size: { label: 'Huis Popup 4 Font Size (px)', helper: 'Font size for house popup line 4.' },
          ...
          sensor_popup_house_5_font_size: { label: 'Huis Popup 5 Font Size (px)', helper: 'Font size for house popup line 5.' },
          ...
          sensor_popup_house_6_font_size: { label: 'Huis Popup 6 Font Size (px)', helper: 'Font size for house popup line 6.' },
          ...
          battery_popup_font_size: { label: 'Batterij Popup Lettergrootte (px)', helper: 'Globale lettergrootte voor alle batterij popup tekst.' },
          ...
          sensor_popup_grid_1_font_size: { label: 'Net Popup 1 Font Size (px)', helper: 'Font size for grid popup line 1.' },
          ...
          sensor_popup_grid_2_font_size: { label: 'Net Popup 2 Font Size (px)', helper: 'Font size for grid popup line 2.' },
          ...
          sensor_popup_grid_3_font_size: { label: 'Net Popup 3 Font Size (px)', helper: 'Font size for grid popup line 3.' },
          ...
          sensor_popup_grid_4_font_size: { label: 'Net Popup 4 Font Size (px)', helper: 'Font size for grid popup line 4.' },
          ...
          sensor_popup_grid_5_font_size: { label: 'Net Popup 5 Font Size (px)', helper: 'Font size for grid popup line 5.' },
          ...
          sensor_popup_grid_6_font_size: { label: 'Net Popup 6 Font Size (px)', helper: 'Font size for grid popup line 6.' },
          ...
          sensor_popup_inverter_1_font_size: { label: 'Omvormer Popup 1 Font Size (px)', helper: 'Font size for inverter popup line 1.' },
          ...
          sensor_popup_inverter_2_font_size: { label: 'Omvormer Popup 2 Font Size (px)', helper: 'Font size for inverter popup line 2.' },
          ...
          sensor_popup_inverter_3_font_size: { label: 'Omvormer Popup 3 Font Size (px)', helper: 'Font size for inverter popup line 3.' },
          ...
          sensor_popup_inverter_4_font_size: { label: 'Omvormer Popup 4 Font Size (px)', helper: 'Font size for inverter popup line 4.' },
          ...
          sensor_popup_inverter_5_font_size: { label: 'Omvormer Popup 5 Font Size (px)', helper: 'Font size for inverter popup line 5.' },
          ...
          sensor_popup_inverter_6_font_size: { label: 'Omvormer Popup 6 Font Size (px)', helper: 'Font size for inverter popup line 6.' }
        },
        options: {
          languages: [
      ...
      es: {
        sections: {
          ...
          battery: { title: 'Batería', helper: 'Configura las entidades de batería. Una batería no es una celda/módulo individual sino una colección de celdas o un paquete de baterías.' },
        ...
        fields: {
          ...
          grid_current_odometer_duration: { label: 'Odómetro Duración (ms)', helper: 'Animation duration in milliseconds.' },
          ...
          sensor_grid_state: { label: 'Sensor Estado Red', helper: 'Entidad sensor para el texto del estado de la red.' },
          ...
          grid_state_font_size: { label: 'Tamaño Fuente Estado Red (px)', helper: '' },
          sensor_solar_state: { label: 'Sensor Estado Solar', helper: 'Entidad sensor para el texto del estado solar. Devuelve "Producing Power" o "Not Producing".' },
          ...
          solar_state_font_size: { label: 'Tamaño Fuente Estado Solar (px)', helper: '' },
          sensor_solar_forecast_today: { label: 'Sensor Previsión Solar Hoy', helper: 'Entidad sensor para la previsión solar de hoy.' },
          sensor_solar_forecast_tomorrow: { label: 'Sensor Previsión Solar Mañana', helper: 'Entidad sensor para la previsión solar de mañana.' },
          sensor_weather_icon: { label: 'Sensor Icono Meteorológico', helper: 'Entidad sensor para el icono meteorológico.' },
          weather_icon_color: { label: 'Color Icono Meteorológico', helper: 'Color aplicado al texto del icono meteorológico.' },
          weather_icon_font_size: { label: 'Tamaño Fuente Icono Meteorológico (px)', helper: '' },
          sensor_weather_forecast: { label: 'Sensor Pronóstico Meteorológico', helper: 'Entidad sensor para el pronóstico meteorológico.' },
          weather_forecast_color: { label: 'Color Pronóstico Meteorológico', helper: 'Color aplicado al texto del pronóstico meteorológico.' },
          weather_forecast_font_size: { label: 'Tamaño Fuente Pronóstico Meteorológico (px)', helper: '' },
          ...
          inverter1_status_font_size: { label: 'Tamaño Fuente Estado Inversor (px)', helper: 'Tamaño de fuente para texto de estado del inversor.' },
          ...
          sensor_car_range: { label: 'Sensor Autonomía Coche 1', helper: 'Entidad sensor para la autonomía del VE 1.' },
          sensor_car_state: { label: 'Sensor Estado de Carga Coche 1', helper: 'Entidad sensor para el texto del estado de carga del VE 1.' },
          sensor_car_hvac_status: { label: 'Sensor Estado HVAC Coche 1', helper: 'Entidad sensor para el estado HVAC/climatización del VE 1.' },
          sensor_car_outside_temp: { label: 'Sensor Temperatura Exterior Coche 1', helper: 'Entidad sensor para la temperatura exterior del VE 1.' },
          sensor_car_inside_temp: { label: 'Sensor Temperatura Interior Coche 1', helper: 'Entidad sensor para la temperatura interior/habitáculo del VE 1.' },
          sensor_car_ac_temp: { label: 'Sensor Temperatura Climatización Coche 1', helper: 'Entidad sensor para la temperatura de consigna de climatización del VE 1.' },
          ...
          sensor_car2_range: { label: 'Sensor Autonomía Coche 2', helper: 'Entidad sensor para la autonomía del VE 2.' },
          sensor_car2_state: { label: 'Sensor Estado de Carga Coche 2', helper: 'Entidad sensor para el texto del estado de carga del VE 2.' },
          sensor_car2_hvac_status: { label: 'Sensor Estado HVAC Coche 2', helper: 'Entidad sensor para el estado HVAC/climatización del VE 2.' },
          sensor_car2_outside_temp: { label: 'Sensor Temperatura Exterior Coche 2', helper: 'Entidad sensor para la temperatura exterior del VE 2.' },
          sensor_car2_inside_temp: { label: 'Sensor Temperatura Interior Coche 2', helper: 'Entidad sensor para la temperatura interior/habitáculo del VE 2.' },
          sensor_car2_ac_temp: { label: 'Sensor Temperatura Climatización Coche 2', helper: 'Entidad sensor para la temperatura de consigna de climatización del VE 2.' },
          ...
          header_font_size: { label: 'Header Font Size (px)', helper: '' },
          daily_label_font_size: { label: 'Diario Etiqueta Font Size (px)', helper: '' },
          daily_value_font_size: { label: 'Diario Value Font Size (px)', helper: '' },
          pv_font_size: { label: 'PV Text Font Size (px)', helper: '' },
          windmill_power_font_size: { label: 'Aerogenerador potencia Font Size (px)', helper: '' },
          battery_soc_font_size: { label: 'Batería SOC Font Size (px)', helper: '' },
          ...
          battery_time_until_font_size: { label: 'Tamaño Fuente Tiempo Restante (px)', helper: '' },
          ...
          battery_state_font_size: { label: 'Tamaño Fuente Estado Batería (px)', helper: '' },
          battery_power_font_size: { label: 'Batería potencia Font Size (px)', helper: '' },
          inv1_datetime_color: { label: 'Color DateTime Inversor 1', helper: 'Color para la visualización datetime de batería Inversor 1' },
          inv1_datetime_font_size: { label: 'Tamaño Font DateTime Inversor 1 (px)', helper: 'Tamaño de fuente para datetime batería Inversor 1.' },
          ...
          inv1_timeuntil_font_size: { label: 'Tamaño Font Tiempo Hasta Inversor 1 (px)', helper: 'Tamaño de fuente para tiempo hasta batería Inversor 1.' },
          inv2_datetime_color: { label: 'Color DateTime Inversor 2', helper: 'Color para la visualización datetime de batería Inversor 2' },
          inv2_datetime_font_size: { label: 'Tamaño Font DateTime Inversor 2 (px)', helper: 'Tamaño de fuente para datetime batería Inversor 2.' },
          ...
          inv2_timeuntil_font_size: { label: 'Tamaño Font Tiempo Hasta Inversor 2 (px)', helper: 'Tamaño de fuente para tiempo hasta batería Inversor 2.' },
          load_font_size: { label: 'Load Font Size (px)', helper: '' },
          ...
          car2_soc_font_size: { label: 'Coche 2 SOC Font Size (px)', helper: '' },
          sensor_popup_pv_1: { label: 'PV Popup 1', helper: 'Entity for PV popup line 1.' },
          sensor_popup_pv_2: { label: 'PV Popup 2', helper: 'Entity for PV popup line 2.' },
          sensor_popup_pv_3: { label: 'PV Popup 3', helper: 'Entity for PV popup line 3.' },
          sensor_popup_pv_4: { label: 'PV Popup 4', helper: 'Entity for PV popup line 4.' },
          ...
          sensor_popup_house_1_font_size: { label: 'Casa Popup 1 Font Size (px)', helper: 'Font size for house popup line 1.' },
          ...
          sensor_popup_house_2_font_size: { label: 'Casa Popup 2 Font Size (px)', helper: 'Font size for house popup line 2.' },
          ...
          sensor_popup_house_3_font_size: { label: 'Casa Popup 3 Font Size (px)', helper: 'Font size for house popup line 3.' },
          ...
          sensor_popup_house_4_font_size: { label: 'Casa Popup 4 Font Size (px)', helper: 'Font size for house popup line 4.' },
          ...
          sensor_popup_house_5_font_size: { label: 'Casa Popup 5 Font Size (px)', helper: 'Font size for house popup line 5.' },
          ...
          sensor_popup_house_6_font_size: { label: 'Casa Popup 6 Font Size (px)', helper: 'Font size for house popup line 6.' },
          ...
          battery_popup_font_size: { label: 'Tamaño fuente popup batería (px)', helper: 'Tamaño fuente global para todo el texto popup batería.' },
          ...
          sensor_popup_grid_1_font_size: { label: 'Red Popup 1 Font Size (px)', helper: 'Font size for grid popup line 1.' },
          ...
          sensor_popup_grid_2_font_size: { label: 'Red Popup 2 Font Size (px)', helper: 'Font size for grid popup line 2.' },
          ...
          sensor_popup_grid_3_font_size: { label: 'Red Popup 3 Font Size (px)', helper: 'Font size for grid popup line 3.' },
          ...
          sensor_popup_grid_4_font_size: { label: 'Red Popup 4 Font Size (px)', helper: 'Font size for grid popup line 4.' },
          ...
          sensor_popup_grid_5_font_size: { label: 'Red Popup 5 Font Size (px)', helper: 'Font size for grid popup line 5.' },
          ...
          sensor_popup_grid_6_font_size: { label: 'Red Popup 6 Font Size (px)', helper: 'Font size for grid popup line 6.' },
          ...
          sensor_popup_inverter_1_font_size: { label: 'Inversor Popup 1 Font Size (px)', helper: 'Font size for inverter popup line 1.' },
          ...
          sensor_popup_inverter_2_font_size: { label: 'Inversor Popup 2 Font Size (px)', helper: 'Font size for inverter popup line 2.' },
          ...
          sensor_popup_inverter_3_font_size: { label: 'Inversor Popup 3 Font Size (px)', helper: 'Font size for inverter popup line 3.' },
          ...
          sensor_popup_inverter_4_font_size: { label: 'Inversor Popup 4 Font Size (px)', helper: 'Font size for inverter popup line 4.' },
          ...
          sensor_popup_inverter_5_font_size: { label: 'Inversor Popup 5 Font Size (px)', helper: 'Font size for inverter popup line 5.' },
          ...
          sensor_popup_inverter_6_font_size: { label: 'Inversor Popup 6 Font Size (px)', helper: 'Font size for inverter popup line 6.' }
        },
        options: {
          languages: [
