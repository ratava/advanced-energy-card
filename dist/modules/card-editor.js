    ...
    return {
      en: {
        ...
        fields: {
          ...
          sensor_bat1_state: { label: 'Battery 1 State Sensor', helper: 'Sensor entity for battery 1 state text.' },
          sensor_bat2_state: { label: 'Battery 2 State Sensor', helper: 'Sensor entity for battery 2 state text.' },
          sensor_bat3_state: { label: 'Battery 3 State Sensor', helper: 'Sensor entity for battery 3 state text.' },
          sensor_bat4_state: { label: 'Battery 4 State Sensor', helper: 'Sensor entity for battery 4 state text.' },
      ...
      it: {
        ...
        fields: {
          ...
          sensor_bat1_state: { label: 'Sensore Stato Batteria 1', helper: 'Entità sensore per il testo dello stato della batteria 1.' },
          sensor_bat2_state: { label: 'Sensore Stato Batteria 2', helper: 'Entità sensore per il testo dello stato della batteria 2.' },
          sensor_bat3_state: { label: 'Sensore Stato Batteria 3', helper: 'Entità sensore per il testo dello stato della batteria 3.' },
          sensor_bat4_state: { label: 'Sensore Stato Batteria 4', helper: 'Entità sensore per il testo dello stato della batteria 4.' },
      ...
      de: {
        ...
        fields: {
          ...
          sensor_bat1_state: { label: 'Batterie 1 Status Sensor', helper: 'Sensor-Entität für den Batterie-1-Status-Text.' },
          sensor_bat2_state: { label: 'Batterie 2 Status Sensor', helper: 'Sensor-Entität für den Batterie-2-Status-Text.' },
          sensor_bat3_state: { label: 'Batterie 3 Status Sensor', helper: 'Sensor-Entität für den Batterie-3-Status-Text.' },
          sensor_bat4_state: { label: 'Batterie 4 Status Sensor', helper: 'Sensor-Entität für den Batterie-4-Status-Text.' },
      ...
      fr: {
        ...
        fields: {
          ...
          sensor_bat1_state: { label: 'Capteur État Batterie 1', helper: 'Entité capteur pour le texte d\'état de la batterie 1.' },
          sensor_bat2_state: { label: 'Capteur État Batterie 2', helper: 'Entité capteur pour le texte d\'état de la batterie 2.' },
          sensor_bat3_state: { label: 'Capteur État Batterie 3', helper: 'Entité capteur pour le texte d\'état de la batterie 3.' },
          sensor_bat4_state: { label: 'Capteur État Batterie 4', helper: 'Entité capteur pour le texte d\'état de la batterie 4.' },
      ...
      nl: {
        ...
        fields: {
          ...
          sensor_bat1_state: { label: 'Batterij 1 Status Sensor', helper: 'Sensor entiteit voor batterij 1 status tekst.' },
          sensor_bat2_state: { label: 'Batterij 2 Status Sensor', helper: 'Sensor entiteit voor batterij 2 status tekst.' },
          sensor_bat3_state: { label: 'Batterij 3 Status Sensor', helper: 'Sensor entiteit voor batterij 3 status tekst.' },
          sensor_bat4_state: { label: 'Batterij 4 Status Sensor', helper: 'Sensor entiteit voor batterij 4 status tekst.' },
      ...
      es: {
        ...
        fields: {
          ...
          sensor_bat1_state: { label: 'Sensor Estado Batería 1', helper: 'Entidad sensor para el texto del estado de la batería 1.' },
          sensor_bat2_state: { label: 'Sensor Estado Batería 2', helper: 'Entidad sensor para el texto del estado de la batería 2.' },
          sensor_bat3_state: { label: 'Sensor Estado Batería 3', helper: 'Entidad sensor para el texto del estado de la batería 3.' },
          sensor_bat4_state: { label: 'Sensor Estado Batería 4', helper: 'Entidad sensor para el texto del estado de la batería 4.' },
